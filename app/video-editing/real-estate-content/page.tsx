...
function VideoPlayerWithBuffering({ src }: { src: string }) {
  ...
  useEffect(() => {
    ...
    // Smart buffering strategy - NO SEEKING to avoid pause/play issues
  ...
  const videos = [
    {
      id: 1,
      title: 'عرض عقاري 1',
      videoSrc: 'https://video-cdn-elramz.b-cdn.net/real%20estate-20251127T095223Z-1-001/real%20estate/Real%20estate%20offers/3.mp4',
      thumbnail: '/11.png',
    },
    {
      id: 2,
      title: 'عرض عقاري 2',
      videoSrc: 'https://video-cdn-elramz.b-cdn.net/real%20estate-20251127T095223Z-1-001/real%20estate/Real%20estate%20offers/5.mp4',
      thumbnail: '/11.png',
    },
    {
      id: 3,
      title: 'عرض عقاري 3',
      videoSrc: 'https://video-cdn-elramz.b-cdn.net/real%20estate-20251127T095223Z-1-001/real%20estate/Real%20estate%20offers/6.mp4',
      thumbnail: '/11.png',
    },
  ]
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {videos.map((video) => (
                ...
                >
                  ...
                  >
                    {/* Video Preview */}
                    <div className="relative w-full h-64 mb-4 rounded-lg overflow-hidden bg-black/20 group">
                      <LazyVideo
                        src={video.videoSrc}
                        className="w-full h-full"
                        muted
