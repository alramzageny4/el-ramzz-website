...
export default function SportsAdsPage() {
  const { t } = useLanguage()
  ...
  const videos = [
    {
      id: 1,
      title: 'إعلان رياضي 1',
      videoSrc: 'https://video-cdn-elramz.b-cdn.net/1.mp4',
      thumbnail: '/11.png',
    },
    {
      id: 2,
      title: 'إعلان رياضي 2',
      videoSrc: 'https://video-cdn-elramz.b-cdn.net/2.mp4',
      thumbnail: '/11.png',
    },
    {
      id: 3,
      title: 'إعلان رياضي 3',
      videoSrc: 'https://video-cdn-elramz.b-cdn.net/4.mp4',
      thumbnail: '/11.png',
    },
    {
      id: 4,
      title: 'إعلان رياضي 4',
      videoSrc: 'https://video-cdn-elramz.b-cdn.net/5_1.mp4',
      thumbnail: '/11.png',
    },
    {
      id: 5,
      title: 'إعلان رياضي 5',
      videoSrc: 'https://video-cdn-elramz.b-cdn.net/6.mp4',
      thumbnail: '/11.png',
    },
  ]
              ...
              >
                ...
                >
                  ...
                  <div className="relative w-full h-64 mb-4 rounded-lg overflow-hidden bg-black/20 group">
                    {/* Video - Only plays on hover for better performance */}
                    <LazyVideo
                      src={video.videoSrc}
                      className="w-full h-full"
                      muted
