      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div ref={cardsRef} className="grid grid-cols-3 gap-3 sm:gap-4 md:gap-6 lg:gap-8">
          {speakers.map((speaker, index) => {
            const cardContent = (
              <div
                className={`relative h-full p-3 sm:p-4 md:p-6 bg-dark-navy/60 backdrop-blur-sm border border-purple-500/30 md:border-2 rounded-lg md:rounded-xl hover:border-neon-purple transition-all duration-150 hover:shadow-glow-purple hover:-translate-y-2 ${
              ...
              >
                ...
                <div className="text-center">
                  <h3 className="text-sm sm:text-sm md:text-lg lg:text-xl font-bold text-white mb-1 sm:mb-2 leading-tight">{speaker.name}</h3>
